...
```powershell
cd "C:\Users\lwz12\Desktop\AI工作台知识库\01-项目\project 多Agent代码协作助手"
...
- 真实项目根是 `C:\Users\lwz12\Desktop\AI工作台知识库\01-项目\project 多Agent代码协作助手`，不要把 `Documents\ChatGPT\agent协作` 当源码根。
